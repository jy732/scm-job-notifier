    ...
    public PipelineMetrics(MeterRegistry registry) {
        ...
        jobsClassified =
                Counter.builder("job.pipeline.classified")
                        .description("Jobs classified as notifiable by Gemini")
                        .register(registry);
        jobsAutoApproved =
        ...
        jobsAutoApprovedFallback =
                Counter.builder("job.pipeline.auto_approved_fallback")
                        .description("Jobs auto-approved (UNSURE) after exhausting Gemini retries")
                        .register(registry);
        ...
        classifyStage2 =
                Counter.builder("job.classify.stage")
                        ...
                        .description("Jobs classified by Stage 2 (YOE/enrollment in JD)")
                        .register(registry);
        classifyStage3 =
                Counter.builder("job.classify.stage")
                        .tag("stage", "gemini")
